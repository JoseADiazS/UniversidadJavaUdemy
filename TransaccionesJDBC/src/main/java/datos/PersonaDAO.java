...
public class PersonaDAO {
    ...
    private static final String SQL_UPDATE = "UPDATE persona SET id_persona = ?,nombre = ?,apellido = ?, email = ?, " +
            "telefono = ?  WHERE id_persona = ?";
    ...
    public int eliminar(Persona persona){
        ...
        try {
            ...
            persona.setIdPersona(Integer.parseInt(scanner.next()));
    ...
    public int actualizar(Persona persona){
        ...
        try {
            ...
            actualiza = Integer.parseInt(scanner.next());
